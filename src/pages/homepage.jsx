  ...
  return (
    <div className='flex flex-col '>
          ...
          <div className='px-4'>
            <div className='w-full  rounded-xl h-52 bg-blue-200 self-center mt-5 p-4'>
                <div className='flex w-full h-fit items-center justify-between'>
                  ...
                  <div className='bg-white rounded-xl h-16 w-fit px-6 text-2xl font-semibold mt-8 ml-2 flex items-center'>$ 000,000.00</div>
            </div>
         ...
         <div className='grid grid-cols-2 p-4 rounded-xl gap-7 mx-4 mt-8
          ...
          <div className='w-40 rounded-xl h-24 bg-gray-200 flex items-center p-4 text-xl  gap-4 hover:bg-gray-400'><FontAwesomeIcon icon={faMoneyBill1Wave} size="xl" /> <p>Receive Money</p></div>
